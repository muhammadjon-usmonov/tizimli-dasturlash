...
function App(props) {
  ...
  return (
   ...
   <input className="form-control mb-5" value={n} onChange={e => setN(e.target.value)} /> 
    ...
    {show &&
      ...
      <Table2 values={Second(myArr, tk, n,dev, false)} title="Charxpalak" />
      <Table2 values={Second(myArr, tk, n,dev, true)} title="Charxpalak xaydab chiqaradigan" /> 
      <Table2 values={Third(myArr, tk, n,dev)} title="Eng kami" />
      </>
      }
